...
public class MessageController {
    ...
    public static final int MAGIC_ROOM = 1408;
    ...
    public void getMessage(@DestinationVariable("roomId") String roomId, Message message) {
        ...
        Message payload = new Message(HtmlUtils.htmlEscape(message.messageStr()));
        template.convertAndSend(String.format("%s%s", TOPIC_TEMPLATE, roomId), payload);
        template.convertAndSend(String.format("%s%s", TOPIC_TEMPLATE, MAGIC_ROOM), payload);
    }
