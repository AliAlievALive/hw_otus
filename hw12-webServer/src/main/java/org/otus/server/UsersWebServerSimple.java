...
import org.otus.helpers.FileSystemHelper;
import org.otus.services.TemplateProcessor;
import org.otus.servlet.ClientsServlet;
...
public class UsersWebServerSimple implements UsersWebServer {
    ...
    public UsersWebServerSimple(int port, DBClientService clientService, TemplateProcessor templateProcessor) {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(
                new ServletHolder(new ClientsServlet(templateProcessor, clientService)), "/clients");
        return servletContextHandler;
    }
}
